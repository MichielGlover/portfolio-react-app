...
import darkThemeImg from "../assets/projects/DarkThemeSwitch.png";
...
const Work = () => {
  return (
    <div
      name="work"
      className="w-full h-screen md:h-screen text-gray-300 bg-[#0a192f]"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-2 gap-4">
          ...
          {/* Grid Item */}
          <div
            style={{ backgroundImage: `url(${darkThemeImg})` }}
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://michielglover.github.io/dark-theme-react-app/">
                  <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">
                    Demo
                  </button>
                </a>
                <a href="https://github.com/MichielGlover/dark-theme-react-app">
                  <button className="text-center rounded-lg px-4 py-3 bg-white text-gray-700 font-bold text-lg">
                    Code
                  </button>
                </a>
